...
public class SysGenerator {
  ...
  // Vue文件输出目录
  private static final String OUTPUT_LOCATION_UNIAPP = "/Users/gxwebsoft/VUE/mp";
  // Vue文件输出目录
  ...
  // 数据库连接配置 - 请根据实际环境修改
  private static final String DB_URL = System.getProperty("db.url", "jdbc:mysql://localhost:3306/gxwebsoft_core?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
